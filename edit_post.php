...
$post_date = $row['post_date'];
 ...
 if(isset($_POST['update_post'])) {
       ...
       echo "Post Updated: " . " " . "<a href='../post.php?p_id={$the_get_post_id}'>View posts</a>" . " or " . "<a href='posts.php'>Edit More Posts</a>";
}
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        <label>Post Image</label> 
         <img width="100" src="../images/<?php echo $post_image?>" name="image"for="post_image">
